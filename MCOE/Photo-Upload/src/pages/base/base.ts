...
import { IonicPage, NavController, NavParams, AlertController, FabContainer, ToastController } from 'ionic-angular';
import { Camera, CameraOptions } from '@ionic-native/camera';
import { Geolocation } from '@ionic-native/geolocation';
import { UploadModel } from '../../models/upload-model/upload-model.interface';
import { UploadServiceProvider } from '../../providers/upload-service/upload-service';
import { Http } from '@angular/http';
import { LocationServiceProvider } from '../../providers/location-service/location-service';
import { EventModel } from '../../models/event-model/event-model.interface';
import { TagModel } from '../../models/tag-model/tag-model.interface';
    ...
    let alert = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'Yes',
          handler: data => {
            this.navCtrl.setRoot('PublicReleasePage');
          }
        }
      ]
    });
